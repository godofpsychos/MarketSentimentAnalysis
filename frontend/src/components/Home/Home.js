        ...
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Advanced analytics powered by cutting-edge AI technology
            </p>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Get instant insights into market sentiment using advanced NLP algorithms and real-time data processing.</p>
            </div>
            
            <div className="feature-card">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24" fill="none">
                  <path d="M3 3V21H21M7 7H17M7 11H17M7 15H13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <h3>Comprehensive Analytics</h3>
              <p>Access detailed charts, trends, and predictive analytics to make informed investment decisions.</p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>Leverage machine learning models to predict market trends and identify profitable opportunities.</p>
            </div>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Join thousands of investors who are already using our platform to make smarter decisions.</p>
